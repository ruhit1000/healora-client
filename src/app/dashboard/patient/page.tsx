  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-4 bg-slate-50">
      <div className="w-full max-w-lg rounded-healora border border-slate-200 bg-white p-8 shadow-sm space-y-3">
        <h1 className="text-2xl font-black text-neutral-text tracking-tight">Patient Dashboard</h1>
        <p className="text-sm text-slate-600">Your role-based patient space is active. You can now build appointment history, prescriptions, and profile sections here.</p>
