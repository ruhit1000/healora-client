          ...
          <div className="hidden md:flex items-center space-x-4">
            {isLoggedIn ? (
              <button
                ...
                className="rounded-md bg-rose-50 px-4 py-2 text-sm font-medium text-rose-600 transition-colors duration-200 hover:bg-rose-100 disabled:opacity-50 disabled:cursor-not-allowed dark:bg-rose-950/40 dark:text-rose-300 dark:hover:bg-rose-900/50"
              >
